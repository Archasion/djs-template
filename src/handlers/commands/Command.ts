import type { ApplicationCommandData, AutocompleteInteraction, CommandInteraction, Snowflake } from "discord.js";
import { DEFAULT_COMMAND_CONTEXTS, DEFAULT_COMMAND_PERMISSIONS, DEFAULT_INTEGRATION_TYPES } from "@/utils/constants";
